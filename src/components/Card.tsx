...
const Card = ({ icon, title, description }: TCard) => {
  return (
    <article className="group relative h-full overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-6 text-left text-white shadow-lg shadow-blue-900/20 backdrop-blur">

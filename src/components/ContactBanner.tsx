	...
	return (
		...
		>
			...
			<div className="relative flex flex-col items-center text-center">
				<div
					className={`mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 text-white shadow-lg transition-all duration-500 ${accentColors[accent]}`}
				>
					{icon}
				</div>
...
const ContactBanner = () => {
	...
	return (
		<section className="relative overflow-hidden bg-linear-to-br from-blue-950 via-blue-900 to-blue-950 py-20">
			...
			<div
				className="absolute bottom-0 right-0 h-96 w-96 rounded-full bg-purple-400/20 blur-3xl animate-pulse"
			...
			<div className="relative z-10 mx-auto w-[90%] max-w-6xl">
				<div className="text-center">
					...
					<p className="mx-auto mb-8 max-w-2xl text-xl leading-relaxed text-gray-200">
						Talk to our AC experts now and get a free consultation for your home
						or business needs
					</p>

	...
	const services = [
		{
			...
			title: "Installation",
			description:
				"Professional setup of all AC types including inverters, ducted, and cassette systems",
		},
		{
			icon: <Snowflake className="h-6 w-6" />,
			title: "Maintenance",
			description:
				"Regular servicing to keep your system running efficiently year-round",
		},
		{
			icon: <Shield className="h-6 w-6" />,
			title: "Repairs",
			description:
				"Fast, reliable repairs with genuine parts and 12-month guarantee",
		},
		{
			icon: <Clock className="h-6 w-6" />,
			title: "24/7 Emergency",
			description:
				"Round-the-clock support for urgent AC breakdowns and issues",
		},
	];
			...
			<div className="relative z-10 mx-auto w-[90%] max-w-7xl">
				...
				<div className="mb-16 text-center">
					...
					<p className="mx-auto max-w-2xl text-lg leading-relaxed text-gray-200 md:text-xl">
						Specialists in installation & repairs for all air conditioning types
						across
